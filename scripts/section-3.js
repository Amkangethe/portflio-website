...
const timelineItems = [
  ...
  { order: 10, side: "right", date: "Jan 2026 - Present", title: "Master of Science", subtitle: "Georgia Institute of Technology", icon: "./icons/schools/gatech.png", link: "https://www.gatech.edu", tags: ["Machine Learning", "Software Engineering", "Cloud"] },
  { order: 30, side: "right", date: "Sept 2022 - May 2025", title: "Bachelor of Science", subtitle: "University of Maryland, Baltimore County", icon: "./icons/schools/umbc.png", link: "https://umbc.edu", tags: ["AI", "Data Structures", "Algorithms", "Software Engineering", "Databases", "Probability", "Statistics"] },
  { order: 40, side: "right", date: "Sept 2020 - May 2022", title: "Associate of Science", subtitle: "Montgomery College", icon: "./icons/schools/mc.png", link: "https://www.montgomerycollege.edu", tags: ["Programming", "Software Design", "Algorithms"] },
];
